<template>
  <div>
    ...
    <div class="container">
      <p>Другие теги:
          <nuxt-link :to="`/tags/${tag.slug}`" class="badge badge-secondary mr-1" v-for="tag in tags" :key="name">#{{ tag.name }}</nuxt-link>
        </p>
      <div class="row">
        
        <div v-for="post in posts" :key="post.slug" class="col-md-4">
            <div class="card mb-4 shadow-sm">
              <div class="card-img-top"><img :src="post.image" alt="" class="card-img-top"></div>
              <div class="card-body">
